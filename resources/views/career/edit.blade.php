...
<div class="container ">
<form class="form" action="{{route('career.update',$career->id)}}" method="post">
...
<input required="required" value="{{ $career->num_available }}" placeholder="{{$career->num_available ??'title here'}}" type="number" name = "num_available"class="form-control" />
